---
number: 9
name: Stainless-Steel Stirred-Tank Bioreactor
part: 2
group: Bioreactor formats
products: [protein, vaccine, indus]
scale: [mid, large, bulk]
cogs: med
maturity: default
regulatory: routine
---
...
- https://www.youtube.com/watch?v=B1YC6SBGdTU — Clean-in-place (CIP) Cycle Animation (Central States Industrial, 2 minutes, 100k+ views)
- https://www.youtube.com/watch?v=pPQhGT-n0JE — Sterilization in Place (Biobridge Healthcare, 6 minutes, 10k+ views)

## Further reading

[Simplifying the Scaling Process Between Bioreactors (Sartorius)](https://www.sartorius.com/en/knowledge/science-snippets/simplifying-the-scaling-process-between-bioreactors-1040122) · [Scale-up of CHO cell cultures: from 96-well-microtiter plates to stirred tank reactors across three orders of magnitude (Journal of Biological Engineering)](https://pmc.ncbi.nlm.nih.gov/articles/PMC11734472/)
