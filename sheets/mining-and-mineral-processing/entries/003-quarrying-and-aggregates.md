...
## Key numbers
Value of $10–20 per ton at the quarry gate · haulage roughly $0.10–0.20 per ton-km, giving an economic radius near 50 km · aggregates are about half of concrete by mass · a typical quarry produces 0.5–5 million tons a year · specification is size, shape, and cleanliness rather than chemistry.

## Examples
Vulcan Materials and Martin Marietta, whose business is essentially a portfolio of quarries near growing cities; manufactured sand plants in India and China where river sand extraction is restricted; recycled concrete aggregate operations in dense urban markets.

## Economic profile
Aggregates are a transport business with a mine attached. Reserves near a city are the asset, and a permitted quarry inside an urban area can be worth many times an identical one an hour further out. That is also why consolidation in the sector is about land position rather than technology, and why recycled aggregate competes well: it is already in the city.

## Videos

- https://www.youtube.com/watch?v=cTwidiB15I8 — Cardinal Aggregate Quarry & Processing Operation (Cardinal Aggregates, 3 minutes, 100k+ views)
- https://www.youtube.com/watch?v=lTwbDQMAnDc — How Does a Rock Get From a Quarry to a Construction Site? (Ashville, 15 minutes, 100k+ views)
- https://www.youtube.com/watch?v=h8Z2O_Ur4x4 — How construction Aggregate is produced | Aggregate (How it Works?, 3 minutes, 10k+ views)
