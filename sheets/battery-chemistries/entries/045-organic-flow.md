...
## Economic profile
Organic flow is a materials-science venture bet layered on an already-hard systems business. The pitch (electrolyte from chemical plants instead of mines) is compelling if stability crosses the decade threshold. Until then, every deal should price electrolyte replacement as an operating cost rather than a one-time capex.

## Videos

- https://www.youtube.com/watch?v=YyzQsVzKylE — Organic Redox Flow Batteries - The true path to grid scale energy storage? (Just Have a Think, 11 minutes, 100k+ views)
- https://www.youtube.com/watch?v=mRYwPKMUyO0 — Kemiwatt's Organic RedOx flow battery (KEMIWATT, 4 minutes, 1k+ views)
