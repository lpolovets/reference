...
Precision is the advantage. Range accuracy of a metre and designation accuracy under a metre give laser-guided weapons their characteristic circular error of one to two meters, which is far better than GPS guidance alone. The equipment is compact and cheap enough for a dismounted team. The weaknesses are weather and exposure. Cloud, fog, smoke, and dust block the beam, and the designator has to keep the spot on the target through the weapon's whole terminal flight, which means someone or something must maintain line of sight and stay put. The beam is also detectable by laser warning receivers.
...
- https://www.youtube.com/watch?v=sTSWQ2tkHW4 — How does laser range finder work? Explained in 3 minutes. (VROOK Learning, 3 minutes, 10k+ views)
- https://www.youtube.com/watch?v=HgyAOQEYolQ — Precision Targeting Device Training (PEO Soldier, 4 minutes, 10k+ views)
- https://www.youtube.com/watch?v=yJfiZNHWIN4 — Technology Explained: How the Paveway II Laser Guided bomb Seeker works (Iron Physik, 20 minutes, 5k+ views)
