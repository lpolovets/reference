...
## Examples
The adenoviral COVID-19 vaccines from Oxford-AstraZeneca and Johnson & Johnson, and the Sputnik V design that used two different serotypes for prime and boost to evade anti-vector immunity; nadofaragene firadenovec, an approved adenoviral product delivered into the bladder; helper-dependent vectors used preclinically to deliver large editing payloads to liver; and the 1999 ornithine transcarbamylase trial, which remains the most consequential safety event in the history of gene therapy.
